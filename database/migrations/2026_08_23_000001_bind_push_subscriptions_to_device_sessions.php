...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // A propriedade de uma assinatura legada nao pode ser presumida. O navegador
        // autenticado a reativa automaticamente ao provar que ainda possui o endpoint.
    ...
    public function down(): void
    {
        ...
        Schema::table('push_subscriptions', function (Blueprint $table) {
            $table->dropIndex('push_subscription_session_active_idx');
            $table->dropColumn(['session_hash', 'bound_at', 'last_seen_at']);
        });
    }
};
