...
<nav class="nav-tabs">
    ...
    <a href="{{ route('associate.deliveries', ['tenant' => $currentTenant->slug]) }}" class="nav-tab active">Entregas</a>
    ...
    <div class="bento-card col-span-full">
        <form method="GET" class="flex gap-4 items-center" style="flex-wrap: wrap;">
            ...
            <div style="margin-top: auto; display: flex; gap: 0.5rem;">
                ...
                <a href="{{ route('associate.deliveries', ['tenant' => $currentTenant->slug]) }}" class="btn btn-outline">Limpar</a>
            </div>
        </form>
    </div>
