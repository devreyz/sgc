            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button 
                        ...
                        type="button"
                        class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg shadow transition-colors"
                    >
    ...
    @else
        <div class="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-4 mb-6 border border-emerald-200 dark:border-emerald-800">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <div class="text-sm text-emerald-800 dark:text-emerald-200 font-medium">Organização</div>
                    <div class="text-lg font-semibold text-emerald-900 dark:text-emerald-100">{{ $currentTenantName }}</div>
                </div>
            </div>
        </div>
    @endif
