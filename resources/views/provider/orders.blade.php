...
<div class="bento-grid">
    ...
    <div class="bento-card col-span-full">
        <div class="flex justify-between items-center" style="flex-wrap:wrap;gap:1rem;">
            ...
            <a href="{{ route('provider.orders.create') }}" class="btn btn-primary">
    ...
    <div class="bento-card col-span-full">
        <form method="GET" class="flex gap-4 items-center" style="flex-wrap: wrap;">
            ...
            <div style="margin-top: auto;">
                <a href="{{ route('provider.orders') }}" class="btn btn-outline">Limpar</a>
            </div>
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:0.5rem;">
                                ...
                                <a href="{{ route('provider.orders.show', $order->id) }}#complete" class="btn btn-primary" style="padding:0.375rem 0.75rem;font-size:0.75rem;">
                                    Concluir
                                </a>
                                @endif
                            </div>
