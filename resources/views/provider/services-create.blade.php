...
<div class="svc-create">
    <header class="svc-create-head">
        ...
        <a
            class="svc-back"
            href="{{ route('provider.orders', $tenantSlug) }}"
    ...
    <form
        ...
        class="svc-form"
        method="post"
        action="{{ route('provider.orders.store', $tenantSlug) }}"
        novalidate
    >
        @csrf
                        ...
                        <label class="svc-field">
                            ...
                            >
                                ...
                                @foreach($providers as $item)
                                    <option
                                        value="{{ $item->id }}"
                                        data-primary="{{ $item->name }}"
                                        data-search="{{ $item->name }}"
                                        data-option-icon="ph-user-gear"
                                        @selected(old('service_provider_id') == $item->id)
                                    >
                                        {{ $item->name }}
                                    </option>
                                @endforeach
                ...
                <div class="svc-fields">
                    ...
                    <label class="svc-field">
                        ...
                        <small
                            ...
                            class="svc-help"
                        >
                            Informe apenas se não escolher um membro.
                        </small>
                    </label>
                </div>
            </div>
