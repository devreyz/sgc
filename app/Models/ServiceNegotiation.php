...
class ServiceNegotiation extends Model
{
    ...
    protected function casts(): array { return ['original_amount'=>'decimal:2','negotiated_amount'=>'decimal:2','terms_snapshot'=>'array']; }
    public function plan(): BelongsTo { return $this->belongsTo(ServicePaymentPlan::class, 'payment_plan_id'); }
