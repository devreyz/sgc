        ...
        return [
            ...
            'delivery_conference_sheet' => [
                ...
                'sections' => [
                    ...
                    'distributions' => 'Checklist de produtos',
                    'financial_summary' => 'Resumo financeiro',
                    'signature' => 'Assinatura e data de entrega',
                ],
                'default_sections' => ['document_info', 'recipient_info', 'distributions', 'signature'],
                'columns' => [
                    'date' => 'Data / período do produto',
                    'customer' => 'Cliente',
                    'product' => 'Produto',
                    'quantity' => 'Quantidade e unidade',
                    'unit_price' => 'Valor médio unitário',
                    'gross_value' => 'Valor total',
                    'ok' => 'Caixa OK',
                    'correction' => 'Espaço para correção',
                ],
                'default_columns' => ['product', 'quantity', 'ok', 'correction'],
            ...
            'project_associate_receipt' => [
                ...
                'default_columns' => ['delivery_date', 'unit_price', 'gross'],
                'paper_orientation' => 'portrait',
            ],
            ...
            'customer_billing_receipt' => [
                ...
                'default_columns' => ['unit_price', 'gross'],
                'paper_orientation' => 'portrait',
            ],
            ...
            'financial_receipt' => [
                'label' => 'Recibo Financeiro de Recebimento',
                'blade_view' => 'pdf.financial-receipt',
                'type' => 'receipt',
                'description' => 'Recibo emitido para valores recebidos pela organizacao',
                'sections' => [
                    'payer_info' => 'Dados do Pagador',
                    'reference' => 'Referencia',
                    'items' => 'Itens',
                    'financial' => 'Valor Recebido',
                    'signature' => 'Assinatura',
                ],
                'columns' => [
                    'position' => 'Numero do Item',
                ...
                'default_columns' => ['position', 'description', 'reference', 'quantity', 'unit', 'unit_price', 'total'],
                'paper_orientation' => 'portrait',
            ],
